    ...
    return (
        ...
        <div className={styles.bcolor}>
            <nav style={{backgroundColor:' #343434'}} className="navbar navbar-expand-lg  navbar-dark fixed-top ">
                <a className={styles.name} href="/#top"><span className={styles.span1}>J</span><span className={styles.span2}> O</span></a>
                {/* <button className="navbar-toggler collapsed" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
                    <span onClick={click} className="navbar-toggler-icon"></span>
                </button> */}
